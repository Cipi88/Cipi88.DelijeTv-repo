...
ADDONTITLE     = '[COLOR=lime]Balkan Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
BUILDERNAME    = '[COLOR=lime]Balkan Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'repository.uk1', 'My_Builds', 'backupdir']
BUILDFILE      = 'http://blackeye.drycloth.org/SLIKE/wizard/wizard.txt'
UPDATECHECK    = 0
APKFILE        = 'https://'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
...
WIZTITLE = '[COLOR=lime]Balkan Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
...
THEME4         = '[COLOR '+COLOR4+']Current Build:[/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
# Current Theme Header / %s is the menu item and is required
THEME5         = '[COLOR '+COLOR4+']Current Theme:[/COLOR] [COLOR '+COLOR2+']%s[/COLOR]'
THEME6         = '[COLOR '+COLOR4+'][B]%s[/B][/COLOR]'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Balkan Green Wizard.'
...
NOTIFICATION   = 'http://blackeye.drycloth.org/SLIKE/wizard/notification.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = '[COLOR=lime]Balkan Green[/COLOR] [COLOR=white]Wizard[/COLOR]'
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'http://blackeye.drycloth.org/SLIKE/wizard/balkan_wizard.jpg'
############################    #############################